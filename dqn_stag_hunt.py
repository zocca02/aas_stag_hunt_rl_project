...
looper = StagHuntLooper(args.n_envs, env_params, parallelization="async" if args.async_envs else "sync", print_rewards=PRINT_REWARDS, test=args.test, seed=SEED, 
                        evaluate_during_training=True, evaluate_every_n_steps=args.time_steps, n_evaluations=4)
